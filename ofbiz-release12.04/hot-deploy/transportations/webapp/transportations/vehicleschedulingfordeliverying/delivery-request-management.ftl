...
<div class="col-lg-2">
    ...
    <div class="form-group">
         <input id="clientId" class="form-control" placeholder="Ma khach hang">
    </div>
    ...
    <div class="form-group">
   	...
   	<button type="button" class="btn btn-primary" onclick="addRequest()">Them diem giao hang</button>
...
function addClient(cl){
	...
	marker.addListener('click', function() {
		document.getElementById("clientId").value = marker.ID;
		lastSelectMarker = marker;
	});					

}

function addClientRequest(cl){
...
function loadClientRequest(){
	$.ajax({
	url: "/transportations/control/get-client-requests",
			type: 'POST',
			success: function(rs){
				console.log(rs);
